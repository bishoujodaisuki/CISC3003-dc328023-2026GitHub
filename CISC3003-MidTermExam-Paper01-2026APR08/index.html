...
<body>
            ...
            <div class="pane-stack pane-stack--a">
                <div class="pane-stack__layer layer-signin">
                    ...
                    <form class="form-fields" id="formSignIn" method="get">
                        ...
                        <button type="submit" class="btn-pill btn-pill--primary">Sign In</button>
                    </form>
                </div>
                <div class="pane-stack__layer layer-signup-promo">
                    <h2>Hello , Again!</h2>
                    <div class="illustration">
                        <img src="images/website_7376495-97b2024f-c498-45be-89ea-fb9065e08963.png" width="140" height="140" alt="">
                    </div>
                    <p class="tagline">Log in to stay connected with us</p>
                    <button type="button" class="btn-pill btn-pill--ghost" id="btnShowSignIn">Sign In</button>
                </div>
            </div>
        </section>

        <section class="auth-card__pane auth-card__pane--b" aria-label="Secondary panel">
            <div class="pane-stack pane-stack--b">
                <div class="pane-stack__layer layer-welcome">
                    <h2>Welcome!</h2>
                    <div class="illustration">
                        <img src="images/unsecure_10399884-b39281a1-5dc3-44df-99a9-cfa1bc755115.png" width="140" height="140" alt="">
                    </div>
                    <p class="tagline">Enter your details to start your journey</p>
                ...
                <div class="pane-stack__layer layer-signup-form">
                    ...
                    <form class="form-fields" id="formSignUp" method="get">
                        ...
                        <button type="submit" class="btn-pill btn-pill--primary">Register</button>
                    </form>
                </div>
            </div>
        </section>
    ...
    <footer class="site-footer">
        CISC3003 Web Programming: dc328023 Jiang Xingyu 2026
    </footer>
